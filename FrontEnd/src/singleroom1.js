            ...
            <section className="single-room container">
               ...
               <div className="single-room-info">
                   ...
                   <article className="info">
                      ...
                      <h6>
                          max capacity : {" "}
                              {person.capacity > 1 ? `${person.capacity} people`: `${person.capacity} person`}
                      </h6>
                      <h6>{person.pets? 'pets allowed': 'no pets allowed'}</h6>
                      <h6>{person.breakfast && "free breakfast included"}</h6>
                   </article>
               </div>
            </section>
